...
void VSimTop___024root___settle__TOP__2(VSimTop___024root* vlSelf) {
    ...
    VL_EXTEND_WI(65,1, __Vtemp5, (1U & (vlSelf->SimTop__DOT__my_core_top__DOT__my_id__DOT___my_decoder_io_alu_op 
                                        >> 1U)));
...
void VSimTop___024root___ctor_var_reset(VSimTop___024root* vlSelf) {
    ...
    vlSelf->SimTop__DOT__my_core_top__DOT___my_id_io_id2ex_rv64w = VL_RAND_RESET_I(1);
    ...
    vlSelf->SimTop__DOT__my_core_top__DOT__my_id__DOT___my_decoder_io_inst_type = VL_RAND_RESET_I(6);
    vlSelf->SimTop__DOT__my_core_top__DOT__my_id__DOT___my_decoder_io_alu_op = VL_RAND_RESET_I(23);
