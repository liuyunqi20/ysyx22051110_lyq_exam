...
void VSimTop___024root____Vdpiimwrap_SimTop__DOT__my_core_top__DOT__my_mem__DOT__my_dmem_port__DOT__cpu_dmem_write_TOP(CData/*0:0*/ en, CData/*0:0*/ wr, QData/*63:0*/ waddr, QData/*63:0*/ wdata, CData/*7:0*/ wmask);
void VSimTop___024root____Vdpiimwrap_SimTop__DOT__my_core_top__DOT__my_mem__DOT__my_dmem_port__DOT__cpu_dmem_read_TOP(CData/*0:0*/ en, CData/*0:0*/ wr, QData/*63:0*/ raddr, QData/*63:0*/ &rdata);
...
void VSimTop___024root___settle__TOP__1(VSimTop___024root* vlSelf) {
    ...
    // Body
    VSimTop___024root____Vdpiimwrap_SimTop__DOT__my_core_top__DOT__my_mem__DOT__my_dmem_port__DOT__cpu_dmem_write_TOP(0U, 1U, 0ULL, 0ULL, 0U);
    ...
    VSimTop___024root____Vdpiimwrap_SimTop__DOT__my_core_top__DOT__my_mem__DOT__my_dmem_port__DOT__cpu_dmem_read_TOP(
                                                                                (1U 
                                                                                & ((IData)(vlSelf->SimTop__DOT__my_core_top__DOT__my_isram__DOT__rstate) 
                                                                                >> 1U)), 0U, vlSelf->SimTop__DOT__my_core_top__DOT__my_if__DOT__nextpc, vlSelf->__Vtask_SimTop__DOT__my_core_top__DOT__my_isram__DOT__my_rmem_port__DOT__cpu_dmem_read__4__rdata);
    vlSelf->SimTop__DOT__my_core_top__DOT__my_isram__DOT___my_rmem_port_rdata 
        = vlSelf->__Vtask_SimTop__DOT__my_core_top__DOT__my_isram__DOT__my_rmem_port__DOT__cpu_dmem_read__4__rdata;
    vlSelf->io_core_data_mem_out_wmask = vlSelf->SimTop__DOT__my_core_top__DOT__my_mem__DOT___wmask_T_10;
    VSimTop___024root____Vdpiimwrap_SimTop__DOT__my_core_top__DOT__my_mem__DOT__my_dmem_port__DOT__cpu_dmem_read_TOP(vlSelf->SimTop__DOT__my_core_top__DOT__my_mem__DOT____Vcellinp__my_dmem_port__en, (IData)(vlSelf->SimTop__DOT__my_core_top__DOT___my_id_io_id2ex_mem_wr), 
                                                                                (0xfffffffffffffff8ULL 
                                                                                & vlSelf->SimTop__DOT__my_core_top__DOT___my_ex_io_ex2mem_result), vlSelf->__Vtask_SimTop__DOT__my_core_top__DOT__my_mem__DOT__my_dmem_port__DOT__cpu_dmem_read__2__rdata);
    vlSelf->SimTop__DOT__my_core_top__DOT__my_mem__DOT___my_dmem_port_rdata 
        = vlSelf->__Vtask_SimTop__DOT__my_core_top__DOT__my_mem__DOT__my_dmem_port__DOT__cpu_dmem_read__2__rdata;
    VSimTop___024root____Vdpiimwrap_SimTop__DOT__my_core_top__DOT__my_mem__DOT__my_dmem_port__DOT__cpu_dmem_write_TOP(vlSelf->SimTop__DOT__my_core_top__DOT__my_mem__DOT____Vcellinp__my_dmem_port__en, (IData)(vlSelf->SimTop__DOT__my_core_top__DOT___my_id_io_id2ex_mem_wr), 
                                                                                (0xfffffffffffffff8ULL 
...
void VSimTop___024root___ctor_var_reset(VSimTop___024root* vlSelf) {
    ...
    vlSelf->SimTop__DOT__my_core_top__DOT__my_if__DOT___io_fs_mem_ok_T_1 = VL_RAND_RESET_I(1);
    ...
    vlSelf->SimTop__DOT__my_core_top__DOT__my_isram__DOT___my_rmem_port_rdata = VL_RAND_RESET_Q(64);
    vlSelf->SimTop__DOT__my_core_top__DOT__my_isram__DOT__rstate = VL_RAND_RESET_I(4);
    vlSelf->SimTop__DOT__my_core_top__DOT__my_isram__DOT___io_ar_ready_T_4 = VL_RAND_RESET_I(1);
    vlSelf->SimTop__DOT__my_core_top__DOT__my_isram__DOT__rdata_r = VL_RAND_RESET_Q(64);
    vlSelf->SimTop__DOT__my_core_top__DOT__my_isram__DOT__unnamedblk1__DOT___rstate_T_5 = VL_RAND_RESET_I(2);
    vlSelf->SimTop__DOT__my_core_top__DOT__my_isram__DOT__my_rmem_port__DOT__tmprdata = VL_RAND_RESET_Q(64);
    vlSelf->__Vtask_SimTop__DOT__my_core_top__DOT__my_mem__DOT__my_dmem_port__DOT__cpu_dmem_read__2__rdata = 0;
    vlSelf->__Vtask_SimTop__DOT__my_core_top__DOT__my_isram__DOT__my_rmem_port__DOT__cpu_dmem_read__4__rdata = 0;
