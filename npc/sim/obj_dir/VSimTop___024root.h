...
VL_MODULE(VSimTop___024root) {
  public:
    ...
    struct {
        ...
        CData/*5:0*/ SimTop__DOT__my_core_top__DOT__my_mem__DOT__ms_state;
        CData/*0:0*/ SimTop__DOT__my_core_top__DOT__my_mem__DOT___io_data_mem_ar_valid_T_5;
        CData/*0:0*/ SimTop__DOT__my_core_top__DOT__my_mem__DOT___io_data_mem_aw_valid_T_4;
        CData/*7:0*/ SimTop__DOT__my_core_top__DOT__my_mem__DOT__rdata_b;
        CData/*0:0*/ SimTop__DOT__my_core_top__DOT__my_mem__DOT__unnamedblk1__DOT___T_1;
