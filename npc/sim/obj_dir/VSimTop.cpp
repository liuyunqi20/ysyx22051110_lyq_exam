...
VSimTop::VSimTop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , __PVT__SimTop__DOT__my_core_top__DOT__my_dcache__DOT__CacheDataRam{vlSymsp->TOP.__PVT__SimTop__DOT__my_core_top__DOT__my_dcache__DOT__CacheDataRam}
    , __PVT__SimTop__DOT__my_core_top__DOT__my_dcache__DOT__CacheDataRam_1{vlSymsp->TOP.__PVT__SimTop__DOT__my_core_top__DOT__my_dcache__DOT__CacheDataRam_1}
    , __PVT__SimTop__DOT__my_core_top__DOT__my_dcache__DOT__CacheDataRam_2{vlSymsp->TOP.__PVT__SimTop__DOT__my_core_top__DOT__my_dcache__DOT__CacheDataRam_2}
    , __PVT__SimTop__DOT__my_core_top__DOT__my_dcache__DOT__CacheDataRam_3{vlSymsp->TOP.__PVT__SimTop__DOT__my_core_top__DOT__my_dcache__DOT__CacheDataRam_3}
    , rootp{&(vlSymsp->TOP)}
{
}
...
static void _eval_initial_loop(VSimTop__Syms* __restrict vlSymsp) {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("../build/SimTop.v", 3616, "",
